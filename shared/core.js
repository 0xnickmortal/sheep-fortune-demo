import { createWalletRegistry, chooseWalletAccount, releaseWallet } from './wallet-providers.js?v=server-wheel-77-v13-20260917-a516cc642097';
import { ensureBscNetwork, isBscChain, loginBscWallet, bscWallet, readWalletTokenBalance } from './wallet-network.js?v=server-wheel-77-v13-20260917-a516cc642097';
...
import { accountFeatures } from './account-features.js?v=server-wheel-77-v13-20260917-a516cc642097';
import { buildWheelSegments, landingIndex, stopAngle } from '../wheel.js?v=server-wheel-77-v13-20260917-a516cc642097';
import { sectorText, resultText } from '../outcome-view.js?v=server-wheel-77-v13-20260917-a516cc642097';
...
const staticRules = LOCAL ? (await import('./rules.js?v=server-wheel-77-v13-20260917-a516cc642097')).RULES : null;
