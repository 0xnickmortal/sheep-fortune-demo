import { INTRO_RECOVERY_TERMS, recoveryDetail } from './protection-view.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
import { createWalletRegistry, chooseWalletAccount, releaseWallet } from './wallet-providers.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
import { ensureBscNetwork, isBscChain, loginBscWallet, bscWallet, readWalletTokenBalance } from './wallet-network.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
...
import { accountFeatures } from './account-features.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
import { buildWheelSegments, landingIndex, stopAngle } from '../wheel.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
import { sectorText, resultText } from '../outcome-view.js?v=server-wheel-77-v13-20260917-75abedd46a0a';
...
const staticRules = LOCAL ? (await import('./rules.js?v=server-wheel-77-v13-20260917-75abedd46a0a')).RULES : null;
