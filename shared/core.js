import { createWalletRegistry, chooseWalletAccount, releaseWallet } from './wallet-providers.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af';
import { ensureBscNetwork, isBscChain, loginBscWallet, bscWallet, readWalletTokenBalance } from './wallet-network.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af';
...
import { accountFeatures } from './account-features.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af';
import { buildWheelSegments, landingIndex, stopAngle } from '../wheel.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af';
import { sectorText, resultText } from '../outcome-view.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af';
...
const staticRules = LOCAL ? (await import('./rules.js?v=server-wheel-77-v13-20260917-cfdf3b7f69af')).RULES : null;
