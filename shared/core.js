import { createWalletRegistry, chooseWalletAccount, releaseWallet } from './wallet-providers.js?v=server-wheel-77-v13-20260917-16d9980c49d1';
import { ensureBscNetwork, isBscChain, loginBscWallet, bscWallet, readWalletTokenBalance } from './wallet-network.js?v=server-wheel-77-v13-20260917-16d9980c49d1';
...
import { accountFeatures } from './account-features.js?v=server-wheel-77-v13-20260917-16d9980c49d1';
import { buildWheelSegments, landingIndex, stopAngle } from '../wheel.js?v=server-wheel-77-v13-20260917-16d9980c49d1';
import { sectorText, resultText } from '../outcome-view.js?v=server-wheel-77-v13-20260917-16d9980c49d1';
...
const staticRules = LOCAL ? (await import('./rules.js?v=server-wheel-77-v13-20260917-16d9980c49d1')).RULES : null;
