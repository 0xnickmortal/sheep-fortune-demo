...
export function protectionNotice(protection, rules) {
  ...
  if (!protection) return '前5把亏损可在下一把补偿，允许差额。详见玩法。';
  if (protection.nextRoundIsRecovery) return `下一把为补偿局：待补偿 ${protection.pendingLoss} 币，按本局金额匹配最接近损失的净盈利倍率，允许差额；规则见玩法说明。`;
