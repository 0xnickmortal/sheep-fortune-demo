...
最新发布：2026-09-18，Worker版本 `21951baa-03ed-477a-a112-47f84e9ee02c`，规则 `server-wheel-77-v13-20260917:first-five-high-stake-recovery-v4`。公开充提保持启用；无需新数据库迁移。前五把补偿、持续大额保护、固定下注档位和手动返佣刷新见 [本次规则说明](前五把补偿与固定档位_20260918.md)。下面的首次接入步骤包含历史关闭状态。
