...
await writeFile('dist/server/wrangler.json', JSON.stringify({ name: 'sheep-fortune-game', main: 'index.js', compatibility_date: '2026-09-01', assets: { directory: '../client', binding: 'ASSETS', run_worker_first: ['/api/*'] } }, null, 2));
