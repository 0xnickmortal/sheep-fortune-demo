...
function requireLive(env){const c=paymentConfig(env);if(!c.enabled)throw new GameError('正式充值提现暂未开放，当前可以使用测试币体验',503,'PAYMENTS_CLOSED');return c;}
